...
with tab3:
    ...
    with p3:
        st.metric("Estimated aluminium purchase cost", "{:,.2f}".format(float(aluminium_cost_total or 0)))
    ...
    with g3:
        st.metric("Estimated glass purchase cost", "{:,.2f}".format(float(glass_cost_total or 0)))
    ...
    with m1:
        st.metric("Aluminium purchase cost", "{:,.2f}".format(float(aluminium_cost_total or 0)))
    with m2:
        st.metric("Glass purchase cost", "{:,.2f}".format(float(glass_cost_total or 0)))
    with m3:
        st.metric("Total material cost", "{:,.2f}".format(float(aluminium_cost_total or 0) + float(glass_cost_total or 0)))
...
with tab5:
    ...
    c1, c2, c3 = st.columns(3)
    with c1:
        st.metric("Profiles BOM cost", "{:,.2f}".format(total_profiles_cost))
    with c2:
        st.metric("Glass BOM cost", "{:,.2f}".format(total_glass_cost))
    with c3:
        st.metric("Combined BOM cost", "{:,.2f}".format(total_profiles_cost + total_glass_cost))
