...
with tab3:
    ...
    with p3:
        st.metric("Estimated aluminium purchase cost", f"{float(aluminium_cost_total or 0):,.2f}")
    ...
    with g3:
        st.metric("Estimated glass purchase cost", f"{float(glass_cost_total or 0):,.2f}")
    ...
    with m1:
        st.metric("Aluminium purchase cost", f"{float(aluminium_cost_total or 0):,.2f}")
    with m2:
        st.metric("Glass purchase cost", f"{float(glass_cost_total or 0):,.2f}")
    with m3:
        st.metric("Total material cost", f"{float(aluminium_cost_total or 0) + float(glass_cost_total or 0):,.2f}")
