...
[data-testid="stSidebar"] {{
    background: linear-gradient(180deg, rgba(255,255,255,0.70), rgba(248,250,252,0.62));
...
.brand-hero {{
    ...
    margin-bottom: 1rem;
    background:
        linear-gradient(135deg, rgba(15,76,129,0.82) 0%, rgba(11,37,57,0.76) 58%, rgba(234,88,12,0.72) 100%);
    color: white;
...
.stButton>button {{
    background: linear-gradient(135deg, rgba(15,76,129,0.88), rgba(11,37,57,0.82)) !important;
    color:white !important;
}}
.stDownloadButton>button {{
    background: linear-gradient(135deg, rgba(249,115,22,0.88), rgba(234,88,12,0.84)) !important;
    color:white !important;
}}
