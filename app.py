...
.stApp {{
background:
linear-gradient(180deg,#eef4ff 0%,#f8fafc 40%,#f8fafc 100%);
}}
...
/* HERO HEADER */
.brand-hero {{
background:linear-gradient(135deg,{primary} 0%,#0b2539 60%,{accent} 100%);
padding:32px;
border-radius:30px;
color:white;
...
.stButton>button {{
background:linear-gradient(135deg,{primary},#0b2539);
color:white;
border:none;
border-radius:12px;
font-weight:800;
