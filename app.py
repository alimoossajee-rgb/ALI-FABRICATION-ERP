...
.stApp {{
    background:
        ...
        radial-gradient(circle at left top, rgba(249,115,22,.10), transparent 22%),
        linear-gradient(180deg,#eef4ff 0%,#f8fafc 42%,#f8fafc 100%);
}}
...
.brand-hero {{
    ...
    background:
        ...
        linear-gradient(135deg, {primary} 0%, #0b2539 56%, {accent} 100%);
    color: white;
    border-radius: 34px;
    padding: 30px 34px;
...
.stButton>button {{
    background: linear-gradient(135deg, {primary}, #0b2539) !important;
    color:white !important;
}}

.stDownloadButton>button {{
    background: linear-gradient(135deg, {accent}, #ea580c) !important;
    color:white !important;
}}
...
with st.sidebar:
    ...
    st.markdown(f"""
<div style='background:white;padding:12px 16px;border-radius:16px;border:1px solid rgba(148,163,184,.15);margin-bottom:10px;'>
<b>Active Project:</b> {st.session_state.active_project_name}
</div>
