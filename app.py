...
@media (max-width: 900px) {{
    ...
    /* Force readable mobile text in summaries and tables */
...
tab0, tab1, tab2, tab3, tab4, tab5 = st.tabs(["🏗️ Project Board", "🪟 Window Studio", "♻️ Offcuts", "📊 Results", "✂️ Visual Layouts", "📦 Schedule & BOM"])
