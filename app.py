...
def inject_brand_css(primary: str, accent: str):
    css = """
        ...
        :root {{
            ...
            --brand-soft: rgba(255,255,255,0.86);
        }}

        .stApp {{
            background:
                radial-gradient(circle at top right, rgba(59,130,246,0.10), transparent 24%),
                radial-gradient(circle at left top, rgba(249,115,22,0.06), transparent 20%),
                linear-gradient(180deg, #f8fafc 0%, #eff6ff 55%, #eef2ff 100%);
        }}
        ...
        .brand-hero {{
            background:
                ...
                linear-gradient(135deg, {primary} 0%, #0b2539 58%, {accent} 100%);
            color: white;
            border-radius: 30px;
            padding: 28px 32px;
