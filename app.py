...
with tab0:
    ...
    for i, window in enumerate(st.session_state.windows):
        ...
        with col:
            ...
            ref_img_html = f'<img class="preview-img" src="data:image/png;base64,{preview_b64}" style="max-height:150px;" />' if preview_b64 else f'<div class="drawing-shell">{card_svg}</div>'
            st.markdown(
                f"""
                <div class="board-card">
                    ...
                    <div class="drawing-shell" style="padding:4px 6px;">{card_svg}</div>
                    <div style="font-size:0.74rem;color:#64748b;font-weight:700;margin-top:-4px;margin-bottom:6px;">Generated drawing</div>
